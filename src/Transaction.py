...
class Transaction():
    ...
    def __init__(self, sender, recipient, data):
        ...
        # a number it is a transfer of FLOPcoin
        # but by making transactions contain arbitrary data that can be interpreted
        # instead of numbers only, the protocol can be softly modified
    ...
    def sign(self, signature):
        ...
        :param signature: the signature created by the sender based on their 
            private key encryption
        """
        self.signature = signature
    
    # Note: miners verify transactions in the ideal system. 
    # No verify() method in here.
